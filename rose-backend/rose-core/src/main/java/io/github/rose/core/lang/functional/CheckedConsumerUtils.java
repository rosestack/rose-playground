...
import io.github.rose.core.lang.functional.checked.CheckedConsumer;
...
public final class CheckedConsumerUtils {
     ...
     * 从受检异常的消费者创建 Try
     * 
     * @param consumer 受检异常的消费者
     * @param input 输入值
     * @param <T> 输入类型
     * @return Try 结果
     */
    public static <T> Try<Void> of(CheckedConsumer<T> consumer, T input) {
