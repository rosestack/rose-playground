...
public class KeystoreKeyLoader implements KeyLoader {
     ...
     */
    public KeystoreKeyLoader(String algorithmName, String keystorePath, 
                           String keystorePassword, String keyAlias, Duration refreshInterval) {
    ...
    private KeyPair doLoadKeyPair() throws Exception {
        ...
        log.info("Keystore密钥加载成功，算法: {}, 别名: {}", 
                privateKey.getAlgorithm(), keyAlias);
