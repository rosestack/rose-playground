...
public class KeyCache<T> {
    ...
    public static class CacheStatus {
        ...
        public CacheStatus(String name, boolean hasValue, Instant lastLoadTime, 
                          boolean expired, Exception lastException) {
            this.name = name;
        ...
        public String toString() {
            return String.format("CacheStatus{name='%s', hasValue=%s, expired=%s, lastLoad=%s}", 
