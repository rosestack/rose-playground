...
public class XxlJobClientConfiguration {
	...
	XxlJobClient xxlJobClient(XxlJobClientAuthInterceptor xxlJobClientAuthInterceptor, ObjectProvider<RestTemplate> restTemplateObjectProvider, XxlJobProperties properties) {
