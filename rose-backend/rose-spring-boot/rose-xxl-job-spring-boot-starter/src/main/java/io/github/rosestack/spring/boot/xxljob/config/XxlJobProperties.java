...
public class XxlJobProperties {
	 ...
	 */
	@NotBlank(message = "管理端地址不能为空")
	@Pattern(regexp = "^https?://.*", message = "管理端地址必须以 http:// 或 https:// 开头")
	...
	@Min(value = 1024, message = "端口号必须大于等于 1024")
	@Max(value = 65535, message = "端口号必须小于等于 65535")
	 ...
	 * 日志保存天数，-1 表示永久
	 */
	@Min(value = -1, message = "日志保留天数必须大于等于 -1")
	...
	public static class Client {
		 ...
		 * 验证用户名和密码的一致性
		 */
		@AssertTrue(message = "如果配置了用户名，则必须配置密码；如果配置了密码，则必须配置用户名")
