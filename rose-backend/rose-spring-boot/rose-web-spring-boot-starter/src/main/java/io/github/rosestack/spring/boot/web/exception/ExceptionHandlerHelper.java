...
public class ExceptionHandlerHelper {
    ...
    public ResponseEntity<ApiResponse<Void>> handleBusinessException(
        ...
        return handleException(exception, request, locale, 400, exception.getMessageKey(), exception.getMessageArgs());
    }
    ...
    public ResponseEntity<ApiResponse<Void>> handleValidationException(
        ...
        return handleException(exception, request, locale, 400, "validation.error", exception.getMessage());
    }
    ...
    public ResponseEntity<ApiResponse<Void>> handleAuthenticationException(
            Exception exception, HttpServletRequest request, Locale locale) {
        return handleException(exception, request, locale, 401, "authentication.error", exception.getMessage());
    }
    ...
    public ResponseEntity<ApiResponse<Void>> handleAuthorizationException(
            Exception exception, HttpServletRequest request, Locale locale) {
        return handleException(exception, request, locale, 403, "authorization.error", exception.getMessage());
    }
    ...
    public ResponseEntity<ApiResponse<Void>> handleNotFoundException(
            Exception exception, HttpServletRequest request, Locale locale) {
        return handleException(exception, request, locale, 404, "resource.not.found", exception.getMessage());
    }
    ...
    public ResponseEntity<ApiResponse<Void>> handleRateLimitException(
            Exception exception, HttpServletRequest request, Locale locale) {
        return handleException(exception, request, locale, 429, "rate.limit.exceeded", exception.getMessage());
    }
    ...
    public ResponseEntity<ApiResponse<Void>> handleInternalServerError(
            Exception exception, HttpServletRequest request, Locale locale) {
        return handleException(exception, request, locale, 500, "internal.server.error", "服务器内部错误");
    }
