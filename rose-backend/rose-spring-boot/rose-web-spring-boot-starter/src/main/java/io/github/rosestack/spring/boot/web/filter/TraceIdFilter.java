package io.github.rosestack.spring.boot.web.filter;
...
import io.github.rosestack.spring.boot.web.config.RoseWebProperties;
...
public class TraceIdFilter extends AbstractBaseFilter {
    ...
    public TraceIdFilter(RoseWebProperties roseWebProperties) {
