 ...
 * 审计详情类型枚举
 * <p>
 * 定义了审计日志详情表中的详情类型分类，用于对详情数据进行分类管理。
 * 详情表采用 JSON 格式存储，支持复杂数据结构。
 * </p>
 *
 * @author Rose Team
 * @since 1.0.0
