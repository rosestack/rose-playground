...
public class NotificationAutoConfiguration {
    ...
    public NoticeService noticeService(NotificationProperties props) {
        ...
        System.setProperty("rose.notification.sender.cache.expireAfterAccessSeconds", String.valueOf(props.getSenderCacheExpireAfterAccessSeconds()));
        System.setProperty("rose.notification.smsProvider.cache.maxSize", String.valueOf(props.getSmsProviderCacheMaxSize()));
        System.setProperty("rose.notification.smsProvider.cache.expireAfterAccessSeconds", String.valueOf(props.getSmsProviderCacheExpireAfterAccessSeconds()));
