...
class RoseDataPermissionHandlerTest {
    ...
    void testGetSqlSegment_WithValidAnnotation() {
        // 测试有效注解的情况
        Table table = new Table("user");
        String mappedStatementId = "io.github.rosestack.mybatis.handler.RoseDataPermissionHandlerTest$TestMapper.selectWithPermission";
    ...
    void testGetSqlSegment_WithAllScope() {
        // 测试全部权限范围
        Table table = new Table("user");
        String mappedStatementId = "io.github.rosestack.mybatis.handler.RoseDataPermissionHandlerTest$TestMapper.selectWithAllScope";
    ...
    void testGetSqlSegment_WithDeptPermission() {
        ...
        String mappedStatementId = "io.github.rosestack.mybatis.handler.RoseDataPermissionHandlerTest$TestMapper.selectWithDeptPermission";
    ...
    void testGetSqlSegment_WithMultipleValues() {
        ...
        String mappedStatementId = "io.github.rosestack.mybatis.handler.RoseDataPermissionHandlerTest$TestMapper.selectWithMultipleValues";
    ...
    void testGetSqlSegment_WithClassLevelAnnotation() {
        ...
        String mappedStatementId = "io.github.rosestack.mybatis.handler.RoseDataPermissionHandlerTest$TestMapperWithClassAnnotation.selectProducts";
    ...
    void testGetSqlSegment_MethodOverridesClass() {
        // 测试方法级别注解覆盖类级别注解
        Table table = new Table("product");
        String mappedStatementId = "io.github.rosestack.mybatis.handler.RoseDataPermissionHandlerTest$TestMapperWithClassAnnotation.selectProductsWithMethodAnnotation";
