...
import io.github.rose.notice.spi.Configurable;

/**
 * 短信服务商 SPI 扩展点，实现类需在 META-INF/services 配置 SPI 文件。
 * getProviderName() 用于唯一标识服务商（如 tencent/aliyun）。
 */

/**
 * 短信服务商 SPI 扩展点。
 * <ul>
 *   <li>type = "tencent"、"aliyun" 等</li>
 *   <li>channelConfig 需包含各服务商所需参数</li>
 * </ul>
 */
