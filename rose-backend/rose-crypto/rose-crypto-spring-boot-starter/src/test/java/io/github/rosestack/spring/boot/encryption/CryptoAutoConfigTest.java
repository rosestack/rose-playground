package io.github.rosestack.spring.boot.crypto;

import io.github.rosestack.crypto.FieldEncryptor;
import io.github.rosestack.crypto.hash.HashService;
import io.github.rosestack.spring.boot.crypto.config.CryptoAutoConfig;
...
class CryptoAutoConfigTest {
    ...
    void shouldNotCreateBeansWhenDisabled() {
        contextRunner
                .withPropertyValues("rose.crypto.enabled=false")
                .run(context -> {
    ...
    static class CustomFieldEncryptor implements FieldEncryptor {
        ...
        @Override
        public String encrypt(String plainText, io.github.rosestack.crypto.enums.EncryptType encryptType) {
            return "custom_encrypted_" + plainText;
        }

        @Override
        public String decrypt(String cipherText, io.github.rosestack.crypto.enums.EncryptType encryptType) {
