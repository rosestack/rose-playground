package io.github.rosestack.spring.boot.crypto.health;

import io.github.rosestack.crypto.CryptoUtils;
...
public class CryptoHealthIndicator implements HealthIndicator {
    ...
    private void checkBasicFunctionality(Health.Builder builder) {
        ...
        try {
            ...
            // 测试 AES 加密解密
            String encrypted = CryptoUtils.encrypt(TEST_PLAIN_TEXT, EncryptType.AES, properties.getSecretKey());
            String decrypted = CryptoUtils.decrypt(encrypted, EncryptType.AES, properties.getSecretKey());
