...
public class CryptoEndpoint {
	...
	public Map<String, Object> crypto() {
		...
		if (properties.isEnabled()) {
			try {
				Map<String, Object> monitoringReport = CryptoMonitorManager.getInstance().getMonitoringReport();
	...
	public Map<String, Object> clearCache() {
		...
		try {
			// 获取清空前的统计
			Map<String, Long> beforeStats = CryptoMonitorManager.getInstance().getPerformanceStats();
