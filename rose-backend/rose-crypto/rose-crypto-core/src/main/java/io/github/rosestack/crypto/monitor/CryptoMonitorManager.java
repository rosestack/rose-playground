package io.github.rosestack.crypto.monitor;
 ...
 */
@Slf4j
public class CryptoMonitorManager {

    /**
     * 单例实例
     */
    private static final CryptoMonitorManager INSTANCE = new CryptoMonitorManager();
     ...
     * 私有构造函数
     */
    private CryptoMonitorManager() {
    }

    /**
     * 获取单例实例
     */
    public static CryptoMonitorManager getInstance() {
        return INSTANCE;
    }
