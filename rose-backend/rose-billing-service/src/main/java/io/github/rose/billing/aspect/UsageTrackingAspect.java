package io.github.rose.billing.aspect;

import io.github.rose.billing.service.BillingService;
import io.github.rose.billing.service.TenantContextHolder;
...
public class UsageTrackingAspect {
    ...
    public void trackApiCall(JoinPoint joinPoint, io.github.rose.billing.aspect.annotation.TrackApiUsage trackApiUsage) {
        try {
