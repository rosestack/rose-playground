...
public class AccessAuthenticationToken extends AbstractJwtAuthenticationToken {

    private static final long serialVersionUID = -8487219769037942225L;

    public AccessAuthenticationToken(RawAccessJwtToken unsafeToken) {
        super(unsafeToken);
    }

    public AccessAuthenticationToken(SecurityUser securityUser) {
        super(securityUser);
    }
}
