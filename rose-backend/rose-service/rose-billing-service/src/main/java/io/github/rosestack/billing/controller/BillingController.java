...
public class BillingController {
    ...
    public ApiResponse<TenantSubscription> createSubscription(@Valid @RequestBody CreateSubscriptionRequest request) {
        TenantSubscription subscription =
                billingService.createSubscription(request.getTenantId(), request.getPlanId(), request.getStartTrial());
    ...
    public ApiResponse<Void> processPayment(
        ...
        billingService.processPayment(
                invoiceId,
                request.getPaymentMethodEnum() == null
                        ? request.getPaymentMethod()
                        : request.getPaymentMethodEnum().name(),
...
class ProcessPaymentRequest {
    ...
    public io.github.rosestack.billing.payment.PaymentMethod getPaymentMethodEnum() {
        try {
            return io.github.rosestack.billing.payment.PaymentMethod.valueOf(paymentMethod);
        } catch (Exception e) {
            return null;
        }
    }
