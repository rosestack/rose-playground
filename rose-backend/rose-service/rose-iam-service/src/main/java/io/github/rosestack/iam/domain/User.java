...
/** withCustomData withDepartment withLastLogin withTenant withUserSource */
@Data
public class User extends BaseTenantEntity implements Serializable {
    ...
    /** 性别: - `M`: 男性，`male` - `F`: 女性，`female` - `U`: 未知，`unknown` */
    ...
    /**
     * 来源类型: - `excel`: 通过 excel 导入 - `register`: 用户自主注册 - `adminCreated`: 管理员后台手动创建（包含使用管理 API 创建用户 ）
     * - `syncTask`: 同步中心的同步任务
     */
