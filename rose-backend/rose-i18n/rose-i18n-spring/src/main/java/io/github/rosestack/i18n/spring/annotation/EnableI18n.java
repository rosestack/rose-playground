 ...
 *
 * <p>The feature could be disabled by the Spring property if {@link
 * I18nConstants#ENABLED_PROPERTY_NAME "rose.i18n.enabled"} is <code>false</code>
 *
...
public @interface EnableI18n {
	...
	/**
	 * Declares the sources of the {@link I18nMessageSource} to register the {@link
	 * I18nMessageSourceFactoryBean} Spring Beans whose names are composed by their source content
	 * appending "ServiceMessageSource", the default value is {@value I18nMessageSource#COMMON_SOURCE
	 * "common"} indicates that the named "commonServiceMessageSource" Spring Bean will be registered.
	 *
	 * <p>Besides the attribute value, the sources will be extended from the Spring property whose
	 * name is {@link I18nConstants#SOURCES_PROPERTY_NAME "rose.i18n.sources"}.
	 *
	 * <p>Finally, all sourced {@link I18nMessageSource} Spring Beans as the members will be
	 * composited into a Primary Spring Bean named {@link I18nConstants#I18N_MESSAGE_SOURCE_BEAN_NAME
