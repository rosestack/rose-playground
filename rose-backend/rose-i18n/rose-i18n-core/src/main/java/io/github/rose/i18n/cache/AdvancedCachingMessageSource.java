 ...
 */
@Slf4j
public class AdvancedCachingMessageSource implements I18nMessageSource {
    ...
    public AdvancedCachingMessageSource(I18nMessageSource delegate,
        ...
        log.info("AdvancedCachingMessageSource initialized with config: {}", config);
    }
    ...
    public void init() {
        if (initialized) {
            log.warn("AdvancedCachingMessageSource already initialized");
            return;
        }
        ...
        try {
            ...
            initialized = true;
            log.info("AdvancedCachingMessageSource initialized successfully");
        } catch (Exception e) {
            log.error("Failed to initialize AdvancedCachingMessageSource", e);
    ...
    public void destroy() {
        if (destroyed) {
            log.warn("AdvancedCachingMessageSource already destroyed");
            return;
        }
        ...
        try {
            ...
            destroyed = true;
            log.info("AdvancedCachingMessageSource destroyed successfully");
        } catch (Exception e) {
    ...
    public String getMessage(String code, Locale locale, Object... args) {
        ...
        if (!initialized) {
            log.warn("AdvancedCachingMessageSource not initialized, falling back to delegate");
