...
class MessageSourceIntegrationTest {
    ...
    void shouldGetMessageWhenChangeMessageSourceProperty(ApplicationContext applicationContext) {
        ...
        I18nMessageSource serviceMessageSource = applicationContext.getBean("commonI18nMessageSource", I18nMessageSource.class);

        assertThat(serviceMessageSource.getMessage("a", Locale.ENGLISH))
                .isEqualTo("a");
        ...
        MatcherAssert.assertThat(parse, hasJsonPath("$.['common.i18n_messages_en.properties'].['a']", equalTo("a.2024")));
    }
